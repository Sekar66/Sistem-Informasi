  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>Kota</td><td>: <INPUT TYPE=TEXT NAME="kota" size="50"></td></tr>

        <tr>
        <td>Nama KUB</td><td>: <INPUT TYPE=TEXT NAME="nama_kub" size="50"></td></tr>

        <tr>
        <td>Nomor Regristrasi</td><td>: <INPUT TYPE=TEXT NAME="nomor_reg" size="50"></td></tr>

        <tr>
        <td>Alamat KUB</td><td>: <INPUT TYPE=TEXT NAME="alamat_kub" size="50"></td></tr>

        <tr>
        <td>Ketua</td><td>: <INPUT TYPE=TEXT NAME="ketua" size="50"></td></tr>

        <tr>
        <td>Jumlah Anggota</td><td>: <INPUT TYPE=TEXT NAME="jumlah_anggota"size="50"></td></tr>

        <tr>
        <td>Status</td><td>: <INPUT TYPE=TEXT NAME="status" size="50"></td></tr>

        <tr>
        <td>Kelas KUB</td><td>: <INPUT TYPE=TEXT NAME="kelas_kub" size="50"></td></tr>

        <tr>
        <tr><td>No Telepon</td><td>: <INPUT TYPE=TEXT NAME="no_tlp" size="50"></td></tr>
        <tr align="center">
