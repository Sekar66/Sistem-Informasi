  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?nelayan_mangunharjo"><b>Data Nelayan <br>Mangunharjo</b></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h2><b>Data Nelayan Mangunharjo</b></h2>
        ...
        while($row = $this->model->fetch($data))
        {
          ...
          echo "
          <td>
          <a href='index.php?edit4=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?hapus3=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add4' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
