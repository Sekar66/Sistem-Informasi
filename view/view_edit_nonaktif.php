  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        value="<?php echo $row[1];?>"></td></tr>
        <tr>
        <td>Nomor Regristrasi</td><td>: <INPUT TYPE=TEXT NAME="no_reg"
        size="50" value="<?php echo $row[2];?>" ></td></tr>
        <tr>
        <td>Alamat</td><td>: <INPUT TYPE=TEXT NAME="alamat"
        size="50" value="<?php echo $row[3];?>"></td></tr>
        <tr>
        <td>Jumlah Anggota</td><td>: <INPUT TYPE=TEXT NAME="jml_anggota"
        size="50" value="<?php echo $row[4];?>" ></td></tr>
        <tr>
        <td>Regristrasi Tahun</td><td>: <INPUT TYPE=TEXT NAME="reg_tahun"
