  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?profil_smgbarat"><b>Kecamatan SEMARANG <br>BARAT</b></a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h2><b>Profil Nelayan Semarang Barat</b></h2>
        <table border = "1" width = "1000px">
        <tr>
        <tr>
          <td align = center><b><font size = 3>No</font></b></td>
          <td align = center><b><font size = 3>Nama Nelayan</font></b></td>
          <td align = center><b><font size = 3>Usia</font></b></td>
          <td align = center><b><font size = 3>Kecamatan</font></b></td>
          <td align = center><b><font size = 3>Kelurahan</font></b></td>
          ...
          <td align = center><b><font size = 3>Ukuran Kapal</font></b></td>
        ...
        while($row = $this->model->fetch($data))
        {
          ...
          echo "
          <td>
          <a href='index.php?edit12=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?hapus11=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add11' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
