  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>Nama</td><td>: <INPUT TYPE=TEXT NAME="nama" size="50"></td></tr>

        <tr>
        <td>NIK</td><td>: <INPUT TYPE=TEXT NAME="nik" size="50"></td></tr>
        ...
        <tr>
        <td>Pas Kecil</td><td>: <INPUT TYPE=TEXT NAME="pas_kecil" size="50"></td></tr>

        <tr>
        <td>Mesin</td><td>: <INPUT TYPE=TEXT NAME="mesin"size="50"></td></tr>

        <tr>
        <td>BBM</td><td>: <INPUT TYPE=TEXT NAME="bbm" size="50"></td></tr>
        ...
        <tr>
        <tr><td>ASNEL</td><td>: <INPUT TYPE=TEXT NAME="asnel" size="50"></td></tr>
