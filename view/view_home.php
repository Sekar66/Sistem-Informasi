    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
          ...
          <td align = center><b><font size = 4>Kota</font></b></td>
          <td align = center><b><font size = 4>Nama KUB</font></b></td>
          <td align = center><b><font size = 4>Nomor Regristrasi</font></b></td>
          <td align = center><b><font size = 4>Alamat</font></b></td>
          <td align = center><b><font size = 4>Ketua</font></b></td>
          <td align = center><b><font size = 4>Jumlah Anggota</font></b></td>
          <td align = center><b><font size = 4>Status</font></b></td>
          <td align = center><b><font size = 4>Kelas KUB</font></b></td>
          <td align = center><b><font size = 4>Nomor Telepon</font></b></td>
          <td align = center><b><font size = 4>Aksi</font></b></td>
          </tr>
        </tr>
        <?php
        while($row = $this->model->fetch($data))
        {
          ...
          echo "
          <td>
          <a href='index.php?edit=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?d=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
