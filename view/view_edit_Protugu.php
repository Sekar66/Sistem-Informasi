  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3"> DATA PERIKANAN </div>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>Nama Nelayan</td><td>: <INPUT TYPE=TEXT NAME="nama_nelayan" 
        size="50" value="<?php echo $row[1];?>"></td></tr>

        <tr>
        <td>Usia</td><td>: <INPUT TYPE=TEXT NAME="usia" 
        size="50" value="<?php echo $row[2];?>"></td></tr>

        <tr>
        <td>Kecamatan</td><td>: <INPUT TYPE=TEXT NAME="kecamatan" 
        size="50" value="<?php echo $row[3];?>"></td></tr>

        <tr>
        <td>Kelurahan</td><td>: <INPUT TYPE=TEXT NAME="kelurahan" 
        size="50" value="<?php echo $row[4];?>"></td></tr>

        <tr>
        <td>Alamat</td><td>: <INPUT TYPE=TEXT NAME="alamat" 
        size="50" value="<?php echo $row[5];?>"></td></tr>

        <tr>
        <td>Alat Tangkap</td><td>: <INPUT TYPE=TEXT NAME="alat_tangkap"
        size="50" value="<?php echo $row[6];?>"></td></tr>

        <tr>
        <td>Nama Kapal</td><td>: <INPUT TYPE=TEXT NAME="nama_kapal" 
        size="50" value="<?php echo $row[7];?>"></td></tr>

        <tr>
        <td>Ukuran Kapal</td><td>: <INPUT TYPE=TEXT NAME="ukuran_kapal" 
        size="50" value="<?php echo $row[8];?>"></td></tr>

        <tr>
        <tr><td>KUB</td><td>: <INPUT TYPE=TEXT NAME="kub" 
