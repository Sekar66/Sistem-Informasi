  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>NIK</td><td>: <INPUT TYPE=TEXT NAME="nik" 
        ...
        <tr>
        <td>Pas Kecil</td><td>: <INPUT TYPE=TEXT NAME="pas_kecil" 
        size="50" value="<?php echo $row[5];?>"></td></tr>

        <tr>
        <td>Mesin</td><td>: <INPUT TYPE=TEXT NAME="mesin"
        size="50" value="<?php echo $row[6];?>"></td></tr>

        <tr>
        <td>BBM</td><td>: <INPUT TYPE=TEXT NAME="bbm" 
        ...
        <tr>
        <tr><td>ASNEL</td><td>: <INPUT TYPE=TEXT NAME="asnel" 
        size="50" value="<?php echo $row[10];?>"></td></tr>
