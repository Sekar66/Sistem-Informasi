  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php">KUB Aktif</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?nelayan_bandarharjo"><b>Data Nelayan <br>Bandarharjo</b></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h2><b>Data Nelayan Bandarharjo</b></h2>
        <table border = "1" width = "1000px">
        <tr>
        <tr>
          <td align = center><b><font size = 3>No</font></b></td>
          <td align = center><b><font size = 3>Nama</font></b></td>
          <td align = center><b><font size = 3>NIK</font></b></td>
          <td align = center><b><font size = 3>Alamat</font></b></td>
          <td align = center><b><font size = 3>Nama Kapal</font></b></td>
          <td align = center><b><font size = 3>Pas Kecil</font></b></td>
          <td align = center><b><font size = 3>Mesin</font></b></td>
          <td align = center><b><font size = 3>BBM</font></b></td>
          <td align = center><b><font size = 3>Alat Tangkap</font></b></td>
          <td align = center><b><font size = 3>KUB</font></b></td>
          <td align = center><b><font size = 3>Asnel</font></b></td>
          <td align = center><b><font size = 3>Aksi</font></b></td>
          </tr>
        </tr>
        <?php
        while($row = $this->model->fetch($data))
        {
          ...
          echo "<td align = center><font size = 2>$row[8]</font></td>";
          echo "<td align = center><font size = 2>$row[9]</font></td>";
          echo "<td align = center><font size = 2>$row[10]</font></td>";
          echo "
          <td>
          <a href='index.php?edit5=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?hapus4=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add5' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
