  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>Nomor Regristrasi</td><td>: <INPUT TYPE=TEXT NAME="no_reg" size="50"></td></tr>
        <tr>
        <td>Alamat</td><td>: <INPUT TYPE=TEXT NAME="alamat" size="50"></td></tr>
        <tr>
        <td>Jumlah Anggota</td><td>: <INPUT TYPE=TEXT NAME="jml_anggota" size="50"></td></tr>
        <tr>
        <td>Regristrasi Tahun</td><td>: <INPUT TYPE=TEXT NAME="reg_tahun" size="50"></td></tr>
        <tr>
        <tr align="center">
