  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?kub_pupi">KUB by PUPI</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <tr>
        <td>No</td><td>: <INPUT TYPE=TEXT NAME="no" size="50"></td></tr>

        <tr>
        <td>Nama Nelayan</td><td>: <INPUT TYPE=TEXT NAME="nama_nelayan" size="50"></td></tr>

        <tr>
        <td>Usia</td><td>: <INPUT TYPE=TEXT NAME="usia" size="50"></td></tr>

        <tr>
        <td>Kecamatan</td><td>: <INPUT TYPE=TEXT NAME="kecamatan" size="50"></td></tr>

        <tr>
        <td>Kelurahan</td><td>: <INPUT TYPE=TEXT NAME="kelurahan" size="50"></td></tr>

        <tr>
        <td>Alamat</td><td>: <INPUT TYPE=TEXT NAME="alamat" size="50"></td></tr>

        <tr>
        <td>Alat Tangkap</td><td>: <INPUT TYPE=TEXT NAME="alat_tangkap"size="50"></td></tr>

        <tr>
        <td>Nama Kapal</td><td>: <INPUT TYPE=TEXT NAME="nama_kapal" size="50"></td></tr>

        <tr>
        <td>Ukuran Kapal</td><td>: <INPUT TYPE=TEXT NAME="ukuran_kapal" size="50"></td></tr>

        <tr>
        <tr><td>KUB</td><td>: <INPUT TYPE=TEXT NAME="kub" size="50"></td></tr>
