  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.html">
          ...
          <span>Data KUB Non-Aktif</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?kub_na"><b>KUB Non Aktif</b></a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h2><b>KUB NON-AKTIF</b></h2>
        <table border = "1" width = "1000px">
        <tr>
        <tr>
          <td align = center><b><font size = 3>No</font></b></td>
          <td align = center><b><font size = 3>Nama KUB</font></b></td>
          <td align = center><b><font size = 3>Nomor Regristrasi</font></b></td>
          <td align = center><b><font size = 3>Alamat</font></b></td>
          <td align = center><b><font size = 3>Jumlah Anggota</font></b></td>
          <td align = center><b><font size = 3>Tahun Regristrasi</font></b></td>
        ...
        while($row = $this->model->fetch($data))
        {
          ...
          echo "
          <td>
          <a href='index.php?edit2=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?hapus=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add2' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
