  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?profil_ngaliyan"><b>Kecamatan NGALIYAN</b></a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <h2><b>Profil Nelayan Ngaliyan</b></h2>
        ...
        while($row = $this->model->fetch($data))
        {
          ...
          echo "
          <td>
          <a href='index.php?edit10=".$row[0]."' class='btn btn-info btn-user btn-block'>
          Edit
          </a>
          <a href='index.php?hapus10=$row[0]' onClick=\"return confirm('Hapus Data?')\" class='btn btn-danger btn-user btn-block'>
          Delete
          </a>
          </td>";
          echo "</tr>";
        ...
        ?>
        <hr>
        <a href='index.php?add10' class='btn btn-primary btn-user btn-xs'>
          TAMBAH DATA
        </a>
        <br>
        <br>
